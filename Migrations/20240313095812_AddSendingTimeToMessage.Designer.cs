...
namespace MVCAuth1.Migrations
{
    ...
    [Migration("20240313095812_AddSendingTimeToMessage")]
    partial class AddSendingTimeToMessage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVCAuth1.Models.Message", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "UserReceive")
                        .WithMany()
                        .HasForeignKey("userReceiveId");

                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "UserSend")
                        .WithMany()
